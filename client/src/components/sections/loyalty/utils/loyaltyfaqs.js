export const loyaltyData = [
  ...
  },
  {
    ...
    answer: (
      <p>
        Can't find your discount code after redeeming your points? We're happy
        to help, here are the steps to finding your code:
        <br />
        <br />
        1. Login
        <br />
        ...
        <br />
        <br />
        4. Click on the 'Approved' button for any reward redemptions, if able to
        be used the code will show there
        <br />
        <br />
        Hope this helps! :)
      </p>
  ...
  },
  {
    ...
    answer: (
      <p>
        ZOX loyalty points expire after 12 months.
        <br />
        <br />
        No worries though! When you have points that are getting close to their
        expiration date, a notice email will be sent over to you. This email
        will include a date of when to use the amount of points close to
        expiring.
      </p>
    ),
  },
